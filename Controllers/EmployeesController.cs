...
namespace CodingAB.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(CodingABContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Employees != null ? 
                          ...
                          Problem("Entity set 'CodingABContext.Employees'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CodingABContext.Employees'  is null.");
            }
            var employee = await _context.Employees.FindAsync(id);
            if (employee != null)
            {
        ...
        public async Task<IActionResult> TimeOffHistory(int? id)
        {
            if (id == null)
            {
                return NotFound();
